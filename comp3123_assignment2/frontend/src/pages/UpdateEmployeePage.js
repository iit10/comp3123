...
const UpdateEmployeePage = () => {
        ...
        const loadEmployee = async () => {
            try {
                ...
                if (employee.profilePictureUrl) {
                    setPreviewUrl(employee.profilePictureUrl);
                }
                
            } catch (err) {
                console.error('Failed to load employee:', err);
                setLoadError('Failed to load employee details. Please try again.');
    ...
    const handleRemovePicture = () => {
        ...
        setPreviewUrl(originalEmployee?.profilePictureUrl || null);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await employeeAPI.updateEmployee(id, updateData);
                        ...
                        <Box>
                            ...
                            <label htmlFor="profile-picture-upload">
                                <Button
                                    ...
                                    sx={{ mr: 2 }}
                                >
                                    {profilePicture ? 'Change Picture' : 'Upload New Picture'}
                                </Button>
                            </label>
